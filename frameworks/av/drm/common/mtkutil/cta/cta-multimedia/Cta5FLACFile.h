...
#ifndef __CTA5_FLAC_FILE_H__
#define __CTA5_FLAC_FILE_H__
 ...
 */
class Cta5FLACFile : public Cta5CommonMultimediaFile
{
public:
    Cta5FLACFile(int fd,String8 key);
    ...
    Cta5FLACFile(String8 mimeType, String8 cid, String8 dcfFlHeaders, uint64_t datatLen, String8 key);

    //Now dcf header is no need
    Cta5FLACFile(String8 mimeType, uint64_t datatLen, String8 key);
public:
    virtual ~Cta5FLACFile(){}
    /*
