...
#ifndef __CTA5_FLV_FILE_H__
#define __CTA5_FLV_FILE_H__
 ...
 */
class Cta5FLVFile : public Cta5CommonMultimediaFile
{
public:
    Cta5FLVFile(int fd,String8 key);
    ...
    Cta5FLVFile(String8 mimeType, String8 cid, String8 dcfFlHeaders, uint64_t datatLen, String8 key);

    //Now dcf header is no need
    Cta5FLVFile(String8 mimeType, uint64_t datatLen, String8 key);
