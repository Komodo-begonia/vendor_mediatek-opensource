...
#ifndef __CTA5_MATROSKA_FILE_H__
#define __CTA5_MATROSKA_FILE_H__
 ...
 */
class Cta5MatroskaFile : public Cta5CommonMultimediaFile
{
public:
    Cta5MatroskaFile(int fd,String8 key);
    ...
    Cta5MatroskaFile(String8 mimeType, String8 cid, String8 dcfFlHeaders, uint64_t datatLen, String8 key);

    //Now dcf header is no need
    Cta5MatroskaFile(String8 mimeType, uint64_t datatLen, String8 key);
public:
    virtual ~Cta5MatroskaFile(){}
    /*
