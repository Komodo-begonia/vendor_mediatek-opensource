...
#ifndef MTK_RTP_SENDER_H_

#define MTK_RTP_SENDER_H_

#include "MtkRTPBase.h"
...
struct MtkRTPSender : public MtkRTPBase, public AHandler {
    enum {
        kWhatInitDone,
        kWhatError,
        kWhatNetworkStall,
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(MtkRTPSender);
...
private:
    ...
    void queuePackets_pro(const sp<ABuffer> &Packets, int64_t timeUs,
                          int64_t latencyB, int64_t startSendUs, int64_t delayUs);
