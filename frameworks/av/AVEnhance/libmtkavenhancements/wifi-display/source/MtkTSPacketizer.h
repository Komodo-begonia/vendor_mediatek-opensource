...
#ifndef Mtk_TS_PACKETIZER_H_

#define Mtk_TS_PACKETIZER_H_
...
// on flags.
struct MtkTSPacketizer : public RefBase {
    enum {
        EMIT_HDCP20_DESCRIPTOR = 1,
        EMIT_HDCP21_DESCRIPTOR = 2,
    };
    explicit MtkTSPacketizer(uint32_t flags);
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(MtkTSPacketizer);
};
