...
#include "MtkMatroskaExtractor.h"
...
ExtractorDef GETEXTRACTORDEF() {
    return {
        ...
        UUID("7370c7a5-7d17-46e7-863b-b8da1b2857cd"),  //mtk uuid
        //UUID("abbedd92-38c4-4904-a4c1-b3f45f899980"),    //google uuid
        1,
        "MtkMatroska Extractor",
        {
            .v3 = {
                [](
                    CDataSource *source,
